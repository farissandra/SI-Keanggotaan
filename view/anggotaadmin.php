	...
	<nav class="navbar navbar-inverse">
	  <div class="container-fluid">
	    ...
	    <ul class="nav navbar-nav">
	      ...
	      <li class="active"><a href="anggotaadmin.php">Data Anggota</a></li>
	      <li><a href="iuranadmin.php">Data Iuran</a></li>
	    ...
	    <table class="table table-striped">
		    ...
		    <tbody>
		      <tr> <!--Buat php fungsi generate ini-->
		        ...
		        <td>Suryo</td>
		        <td>1234567890</td>
		        <td>Jl. Mulyos No.69 Kec.TMB Kab.Surabaya</td>
		        <td>Surabaya, 12 Februari 2015</td>
		        <td>21 Desember 2012</td>
		        <td>
		        	<a href="#">View</a>
		        	<a href="anggotaedit.php">Edit</a>
		        	<a href="#">Delete</a>
		        </td>
		      </tr>
		    </tbody>
